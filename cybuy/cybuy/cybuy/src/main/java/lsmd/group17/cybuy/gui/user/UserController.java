...
public class UserController extends Controller {
    ...
    public void setLink(Session s){
        ...
        if(user == null){
            ...
            password.setText(new String(new char[user.getPassword().length()]).replace("\0","\u2022"));


            deleteAccount.setOnMouseClicked((event) -> this.deleteAccount(user));
    ...
    private void deleteAccount(User u){
        //TODO call some event handler to delete the user
        System.out.println("delete account sent");
    }

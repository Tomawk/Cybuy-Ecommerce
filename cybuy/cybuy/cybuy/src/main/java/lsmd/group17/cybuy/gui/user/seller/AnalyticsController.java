...
public class AnalyticsController extends Controller {
    ...
    public void setLink(Session s) {
        ...
        if(user == null || user.getRole().equals("User")){
            ...
            //TODO di default dovrebbe prendere le analytics del mese corrente,
            // però dare la possibilità di visualizzare anche quelle del mese passato
            ...
            // TODO quando si da la possibilità di scegliere anche il mese precedente questa andrebbe cambiata

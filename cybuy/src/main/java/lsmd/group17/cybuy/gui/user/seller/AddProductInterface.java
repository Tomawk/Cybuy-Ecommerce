...
public class AddProductInterface extends GraphicInterface {
    ...
    private final Menu category_menu;
    private final TextArea description_input;
    private final ScrollPane scrollPane;
    private final HashMap<TextField, TextField> detailMap;
    private final EventHandler eventHandler;

    private final ArrayList<TextField> inputs; //(0) image url | (1) price | (2) quantity
    ...
    /**
     * Setup the scrollpane content
     * @param fifth_row anchorpane
     */
    ...
    /**
     * Function that display a new rect with the 2 detail fields after the user clicks on the + btn
     * @param fifth_row The anchorpane that will contain the new rect
     * @param y for the vertical positioning
     */
    ...
    /**
     * Function called when the user clicks on Add Product button
     */
    ...
    private void addProductClick(){
        ...
        for (TextField input : inputs) {
            inputs_strings.add(input.getText());
        }
    ...
    private void display_success(){
        ...
        //wait for 2 second and then reset the interface in order to add immediately new products
        PauseTransition delay = new PauseTransition(Duration.seconds(2));
        delay.setOnFinished( event -> resetSuccess() );
        delay.play();
    }
    ...
    /**
     * Display the actual selected category in the JavaFx Menu
     * @param menuItems the menuitem selected
     */

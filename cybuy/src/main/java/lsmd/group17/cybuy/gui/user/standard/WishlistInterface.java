...
public class WishlistInterface extends GraphicInterface {
    ...
    private void setWishlist(){
            ...
            for(int i=0;i<num_products;i++){
                ...
                bin_btn.setOnMouseClicked(event -> removeSelectedArticle(this_product));

                //Click event on add to cart btn
                add_cart_btn.setOnMouseClicked(event -> addSelectedArticleToCart(this_product));
    ...
    private void addSelectedArticleToCart(Product product){

...
public class LevelDB {
    ...
    /** Function that retrieves all products in user's cart
     * @param user_id   user we want to retrieve cart of
     ...
     */
     public int removeProductCart(String user_id, Product product){
        ...
        //Check if the product is already present in the cart -> i need to decrease the quantity
        String product_id = product.getObjectId();
        String key = "cart:user:" + user_id + ":product:" + product_id +":quantity";
        String quantity = getValue(key);
    ...
    /**
     * Function that updates the quantity of the product passed as parameter in
     * the cart of the user passed as parameter
     * @param user_id   user we want to update the cart of
    ...
    /**
     * Function that retrieves all products in user's wishlist
     * @param user_id   user we want to retrieve wishlist of
     * @return a list of product
     * @throws IOException exception
     */
